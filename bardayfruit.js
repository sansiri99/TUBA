    ...
    reader.onload = async function(event) {
      ...
      uploadForm.append('filename', fileName);
        ...
        try {
          ...
          hideLoadingSpinner();
          if (result.url) {
            sendLineNotify('bardayfruit', result.url);  // Call the new LINE Notify function
            window.location.href = `complete.html?fileUrl=${encodeURIComponent(result.url)}&formType=bardayfruit`;
          } else {
